...
#os.chdir(export_path + storage_id)
...
def copy_vm():
    for dir_saved in dir_to_copy:
        try:
            import tarfile
            with tarfile.open(export_path + vm_name + ".tar", "a") as tar:
                tar.add(dir_saved)
        except OSError as e:
            print(e)
        #copytree(dir_saved, export_path)
#    try:
        #os.mkdir(export_path + vm_name)
#        shutil.copytree('/exportdomain/e412a6d5-8d62-4df5-a71c-352c50287a55/master/vms/696121ff-d098-4b3b-bd23-f357037608b1',
#                export_path + vm_name + '/696121ff-d098-4b3b-bd23-f357037608b1')

        # funciona!!!!
        #shutil.copytree('/exportdomain/e412a6d5-8d62-4df5-a71c-352c50287a55/',
        #            export_path + vm_name)
#    except OSError as e:
#        print(e)
